/* eslint-disable @typescript-eslint/no-non-null-assertion -- need to fix */
/* eslint-disable @typescript-eslint/no-unsafe-argument -- need to fix */
/* eslint-disable @typescript-eslint/no-shadow -- need to fix*/
/* eslint-disable @typescript-eslint/no-explicit-any -- need to fix */
/* eslint-disable no-nested-ternary -- need to fix */
